...
PRESET_CASES = {
    "concise_style": {
        "system": (
            "你是一个专业的文学改写工具，仅执行文风转换任务。"
            "你的唯一职责是：将文本改写为语言简洁明快、逻辑严密、节奏紧凑、善于营造氛围的叙事风格，保持内容完全一致。"
            "严格禁止：(1)添加任何原文不存在的信息、情节、人物、对话；(2)删减或略去任何原文信息；"
            "(3)在改写结果后继续生成任何内容；(4)生成任何解释、评论、提示或元信息。"
            "输出格式：直接给出改写后的文本，不包含任何其他内容。改写完成后立即停止生成。"
            "⚠️ 禁止输出改写内容以外的任何字，违者报错。输出完改写结果后必须立即终止，不得继续任何形式的文本生成。"
        ...
        "user": (
            "任务：将以下文本改写为语言简洁明快、逻辑严密、节奏紧凑、善于营造氛围的叙事风格。\n"
            "要求：(1)严格保持所有信息点不变；(2)只改变表达方式和叙事节奏；(3)禁止添加任何新内容。\n"
            "原文：" + ORIGINAL_TEXT + "\n"
            "请直接输出改写结果，不要有任何其他内容："
        ),
        "description": "简洁紧凑风格改写测试",
    },
    "elegant_style": {
        "system": (
            "你是一个专业的文学改写工具，仅执行文风转换任务。"
            "你的唯一职责是：将文本改写为用词雅致古朴、情节委婉曲折、注重情感细节和人物心理的叙事风格，保持内容完全一致。"
            "严格禁止：(1)添加任何原文不存在的信息、情节、人物、对话；(2)删减或略去任何原文信息；"
            "(3)在改写结果后继续生成任何内容；(4)生成任何解释、评论、提示或元信息。"
            "输出格式：直接给出改写后的文本，不包含任何其他内容。改写完成后立即停止生成。"
            "⚠️ 禁止输出改写内容以外的任何字，违者报错。输出完改写结果后必须立即终止，不得继续任何形式的文本生成。"
        ...
        "user": (
            "任务：将以下文本改写为用词雅致古朴、情节委婉曲折、注重情感细节和人物心理的叙事风格。\n"
            "要求：(1)严格保持所有信息点不变；(2)只改变表达方式和叙事方式；(3)禁止添加任何新内容。\n"
            "原文：" + ORIGINAL_TEXT + "\n"
            "请直接输出改写结果，不要有任何其他内容："
        ),
        "description": "雅致细腻风格改写测试",
    },
    "general_rewrite": {
        "system": DEFAULT_SYSTEM,
        "user": (
            "任务：将以下文本改写为更具文学性的表达方式。\n"
            "要求：(1)严格保持所有信息点不变；(2)只改变表达方式；(3)禁止添加任何新内容。\n"
            "原文：" + ORIGINAL_TEXT + "\n"
            "请直接输出改写结果，不要有任何其他内容："
        ),
        "description": "通用文学改写测试",
    },
}
